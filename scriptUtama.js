function main() {
    ...
    var handleKeys = function () {
        ...
        if (keys["n"]) {
            rotateXGirl += 0.05; // Rotasi
            translateXGirl += 0.05; // Translasi
        }
        if (keys["b"]) {
            rotateXMinion += 0.05; // Rotasi
            translateXMinion += 0.05; // Translasi
        }
        if (keys["m"]) {
            rotateXGru += 0.05; // Rotasi
            translateXGru += 0.05; // Translasi
        }
    };
    var drag = false;
    var dX = 0;
...
// appus
    ...
    girlHead.child.push(girlTelapakKiri);
     ...
     // Menambahkan daun-daun
     var daun1 = new MyObject(sphere(5, 11, 5, 2, 1, 1, 100, 100, 0, 1, 0).vertex, sphere(5, 11, 5, 2, 1, 1, 100, 100, 0, 1, 0).indices, shader_vertex_source, shader_fragment_source);
     daun1.setup();
     environment.child.push(daun1);
 
     var daun2 = new MyObject(sphere(6, 12, 5, 2, 1, 1, 100, 100, 0, 1, 0).vertex, sphere(6, 12, 5, 2, 1, 1, 100, 100, 0, 1, 0).indices, shader_vertex_source, shader_fragment_source);
     daun2.setup();
     environment.child.push(daun2);
 
     var daun3 = new MyObject(sphere(4, 12, 5, 2, 1, 1, 100, 100, 0, 1, 0).vertex, sphere(4, 12, 5, 2, 1, 1, 100, 100, 0, 1, 0).indices, shader_vertex_source, shader_fragment_source);
     daun3.setup();
     environment.child.push(daun3);
 
     var daun4 = new MyObject(sphere(5, 12, 6, 2, 1, 1, 100, 100, 0, 1, 0).vertex, sphere(5, 12, 6, 2, 1, 1, 100, 100, 0, 1, 0).indices, shader_vertex_source, shader_fragment_source);
     daun4.setup();
     environment.child.push(daun4);
 
     var daun5 = new MyObject(sphere(5, 12, 4, 2, 1, 1, 100, 100, 0, 1, 0).vertex, sphere(5, 12, 4, 2, 1, 1, 100, 100, 0, 1, 0).indices, shader_vertex_source, shader_fragment_source);
     daun5.setup();
     environment.child.push(daun5);
 
     // Mengatur posisi batang pohon terlebih dahulu
     var batangPohon = new MyObject(CylinderVertical(0, 0, 0, 1, 1, 12, 0.545, 0.271, 0.075), Cylindices(), shader_vertex_source, shader_fragment_source);
     batangPohon.setup();
     environment.child.push(batangPohon);
 
     var posYDaun = 12 + 2;
 
     var daun1 = new MyObject(
         sphere(0, posYDaun, 0, 2, 1, 1, 100, 100, 0, 1, 0).vertex,
         sphere(0, posYDaun, 0, 2, 1, 1, 100, 100, 0, 1, 0).indices,
       ...
       var daun2 = new MyObject(
         sphere(2, posYDaun, 0, 2, 1, 1, 100, 100, 0, 1, 0).vertex,
         sphere(2, posYDaun, 0, 2, 1, 1, 100, 100, 0, 1, 0).indices,
         shader_vertex_source,
         shader_fragment_source
       );
       daun2.setup();
       ...
       var daun4 = new MyObject(
         sphere(0, posYDaun, 2, 2, 1, 1, 100, 100, 0, 1, 0).vertex,
         sphere(0, posYDaun, 2, 2, 1, 1, 100, 100, 0, 1, 0).indices,
         shader_vertex_source,
         shader_fragment_source
       );
       daun4.setup();
    ...
    var animate = function (time) {
        ...
        // // Update transformasi untuk Minion 
        // MINION_MODEL_MATRIX = LIBS.get_I4();
        // LIBS.translateX(MINION_MODEL_MATRIX, -30 + translateXMinion); // Perbarui sesuai dengan input
        // LIBS.rotateX(MINION_MODEL_MATRIX, rotateXMinion);
        // LIBS.rotateY(MINION_MODEL_MATRIX, rotateYMinion);
        // LIBS.rotateZ(MINION_MODEL_MATRIX, rotateZMinion);
        // LIBS.scale(MINION_MODEL_MATRIX, Math.abs(scaleXMinion), Math.abs(scaleYMinion), Math.abs(scaleZMinion));
        ...
        // // Update transformasi untuk Gru
        // GRU_MM = LIBS.get_I4();
        // LIBS.translateX(GRU_MM, 30 + translateXGru); // Perbarui sesuai dengan input
        // LIBS.rotateX(GRU_MM, rotateXGru);
        // LIBS.rotateY(GRU_MM, rotateYGru);
        // LIBS.rotateZ(GRU_MM, rotateZGru);
        // LIBS.scale(GRU_MM, Math.abs(scaleXGru), Math.abs(scaleYGru), Math.abs(scaleZGru));
        ...
        // Update transformasi untuk Girl
        GIRL_MM = LIBS.get_I4();
        LIBS.rotateX(GIRL_MM, rotateXGirl);
        LIBS.translateX(GIRL_MM, translateXGirl);
        LIBS.rotateY(GIRL_MM, rotateYGirl);
    ...
    // Mengatur posisi pohon
    POHON_MODEL_MATRIX = LIBS.get_I4();
    LIBS.translateX(POHON_MODEL_MATRIX, 5); // Menyesuaikan posisi X sesuai kebutuhan
    LIBS.translateY(POHON_MODEL_MATRIX, -5); // Menyesuaikan posisi Y sesuai kebutuhan
    batangPohon.MODEL_MATRIX = POHON_MODEL_MATRIX;
    // Mengatur posisi daun1 relatif terhadap batangPohon
    LIBS.set_I4(daun1.MODEL_MATRIX); // Reset transformasi daun1
    LIBS.multiply(daun1.MODEL_MATRIX, POHON_MODEL_MATRIX); // Gunakan matriks batang pohon sebagai dasar
    LIBS.translateY(daun1.MODEL_MATRIX, 12); // Asumsi ini adalah tinggi batang pohon, sesuaikan sesuai kebutuhan
    // Mengatur posisi daun1 relatif terhadap batangPohon
    LIBS.set_I4(daun2.MODEL_MATRIX); // Reset transformasi daun1
    LIBS.multiply(daun2.MODEL_MATRIX, POHON_MODEL_MATRIX); // Gunakan matriks batang pohon sebagai dasar
    LIBS.translateY(daun2.MODEL_MATRIX, 12); // Asumsi ini adalah tinggi batang pohon, sesuaikan sesuai kebutuhan
    // Mengatur posisi daun1 relatif terhadap batangPohon
    LIBS.set_I4(daun3.MODEL_MATRIX); // Reset transformasi daun1
    LIBS.multiply(daun3.MODEL_MATRIX, POHON_MODEL_MATRIX); // Gunakan matriks batang pohon sebagai dasar
    LIBS.translateY(daun3.MODEL_MATRIX, 12); // Asumsi ini adalah tinggi batang pohon, sesuaikan sesuai kebutuhan
    // Mengatur posisi daun1 relatif terhadap batangPohon
    LIBS.set_I4(daun4.MODEL_MATRIX); // Reset transformasi daun1
    LIBS.multiply(daun4.MODEL_MATRIX, POHON_MODEL_MATRIX); // Gunakan matriks batang pohon sebagai dasar
    LIBS.translateY(daun4.MODEL_MATRIX, 12); // Asumsi ini adalah tinggi batang pohon, sesuaikan sesuai kebutuhan
    // Mengatur posisi daun1 relatif terhadap batangPohon
    LIBS.set_I4(daun5.MODEL_MATRIX); // Reset transformasi daun1
    LIBS.multiply(daun5.MODEL_MATRIX, POHON_MODEL_MATRIX); // Gunakan matriks batang pohon sebagai dasar
    LIBS.translateY(daun5.MODEL_MATRIX, 12); // Asumsi ini adalah tinggi batang pohon, sesuaikan sesuai kebutuhan
